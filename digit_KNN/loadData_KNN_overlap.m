function [train, val, test, train_patch,val_patch,test_patch] = loadData_KNN_overlap(sizeRatio)
...
for n =1:size(train.x,1)
    ...
    i = 0;
    while i<28
        temp1 = [temp1,temp(1,1+i*28:20+i*28)];
        temp2 = [temp2,temp(1,9+i*28:28+i*28)];
        i = i+1;
    end
    temp11 = temp1(1:400);
    temp12 = temp1(161:end);
    temp21 = temp2(1:400);
    temp22 = temp2(161:end);
