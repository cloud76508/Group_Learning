...
while n <= 600
    ...
    segment = [evenImages(:,randomOrder1(1:400)), oneImages(:,randomOrder2(1:400))];
    digitLabel = [evenLabels(randomOrder1(1:400),1); oneLabels(randomOrder2(1:400),1)];
    
    randomOrder3 = randperm(length(digitLabel));
    segment = segment(:,randomOrder3);
    digitLabel = digitLabel(randomOrder3,1);
    
    saveSeg = sprintf('C:\\Users\\User\\Desktop\\IJCNN\\digit\\positive\\differ_ratio\\segment%d.mat',n);
    saveLab = sprintf('C:\\Users\\User\\Desktop\\IJCNN\\digit\\positive\\differ_ratio\\label%d.mat',n);
