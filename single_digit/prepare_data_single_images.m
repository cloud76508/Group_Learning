...
%Image1 = letters(:,letters_labels== 10 | letters_labels==16);
%Image2 = digits(:,digit_labels== 7 | digit_labels==5);

Image1 = digits(:,digit_labels== 5);
Image2 = digits(:,digit_labels== 8);

%Image1 = letters(:,letters_labels== 4);
%Image2 = letters(:,letters_labels== 7);
