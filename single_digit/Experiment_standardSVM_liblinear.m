...
% liblinear
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    option_liblinear = ['-w+1 ', num2str(weight), ' -w-1 1 -c ', num2str(C(idx)), ' -s 0 -q'];
...
% %liblinear
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
option_liblinear = ['-w+1 ', num2str(weight), ' -w-1 1 -c ', num2str(opt_C), ' -s 0 -q'];
...
(sum(tempPosiTest>0) + sum(tempNegaTest<0))/1000
