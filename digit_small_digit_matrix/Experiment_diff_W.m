...
for w = 1:length(window_size_list)
    ...
    [trainPositiveData, trainNegativeData, valPositiveData,...
        valNegativeData,testPositiveList, testNegativeList]  = loadData(sample_size, sample_size, test_size);
    ...
    for n=1:sample_size
        ...
        [~,window_data] = partition(eachData,window_size);
    ...
    for n =1:size(testPositiveList,1)
        ...
        [number_windows,testPositiveData] = partition(temp_data.segment,window_size);
    ...
    for n =1:size(testNegativeList,1)
        ...
        [number_windows,testNegativeData] = partition(temp_data.segment,window_size);
    ...
    % % save results
    % %--------------------------------------------------------------
    pathToResults = 'C:\Users\User\Documents\GitHub\Group_Learning\digit_small_digit_matrix\Results\';
    fileName = sprintf('Group_R_W%d_5.mat',window_size_list(w));
