function [trainPositiveData, trainNegativeData, valPositiveData, valNegativeData,testPositiveList, testNegativeList]  = loadData(train_size, val_size, test_size, w_size)
% This function is applied to segmentation_for_CNN for Group Learning with
