...
%window_size_list = [14,28];
%window_size_list = [20,32,35,50,55,60, 61, 62, 63];
window_size_list = [10,15,20,25,30,35,40,45, 50, 55, 60];
...
for w = 1:length(window_size_list)
    ...
    for n=1:sample_size
        ...
        [~,window_data] = partition_sd(eachData,window_size);
    ...
    for n =1:size(testPositiveList,1)
        ...
        [number_windows,testPositiveData] = partition_sd(temp_data.character,window_size);
        testPositiveData = double(testPositiveData);
    ...
    for n =1:size(testNegativeList,1)
        ...
        [number_windows,testNegativeData] = partition_sd(temp_data.character,window_size);
        testNegativeData = double(testNegativeData);
    ...
    % % save results
    % %--------------------------------------------------------------
    pathToResults = 'C:\Users\ASUS\Documents\GitHub\Group_Learning\chinese_character\Results\';
